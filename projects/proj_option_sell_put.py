...
opt = spark.read.parquet('data/opprcd_1996_2019')\
    ...
    .drop('ticker')
opt = data_manipulator.prc_to_r(opt, 'optionid', 'date', 'opt_prc', 'opt_r', fee=0)
opt = data_manipulator.r_to_cumr(opt, 'optionid', 'date', 'opt_r', 1, 30, 'opt_forward_r_30')
opt = data_manipulator.r_to_cumr(opt, 'optionid', 'date', 'opt_r', 1, 1, 'opt_forward_r_1')
opt = data_manipulator.r_to_cumr(opt, 'optionid', 'date', 'opt_r', 1, Window.unboundedFollowing, 'opt_forward_r_exp')
opt = data_manipulator.add_timeseries_zscore(opt, 'cusip', 'date', 'impl_volatility', zscore_start, 0, 'IV_zscore')
